...
@click.command()
@click.option('--mode', default='edit', help='create a new image using Dall-E or edit an existing image, options - e/C')
...
@click.option('--palette_count', default=8, help='number of colors for your palette')
